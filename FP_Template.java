...
public class FP_Template {
	...
	private static void fifo(){
		System.out.println("Beginning FIFO algorithem.");
	...
	//LFU is like FIFO, except it resets the physical frames points to zero if it is a hit.
